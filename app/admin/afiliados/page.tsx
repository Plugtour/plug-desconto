    ...
    <main className="space-y-4">
      ...
      >
        <table className="w-full table-fixed text-left">
          {/* Nome bem menor + direita com espaço real para não sobrepor */}
            <colgroup>
            <col /> {/* Nome (auto) */}
            <col /> {/* Email (auto) */}
            <col style={{ width: '140px' }} /> {/* WhatsApp */}
            <col style={{ width: '150px' }} /> {/* Cupom */}
            <col style={{ width: '120px' }} /> {/* Status */}
            <col style={{ width: '90px' }} />  {/* Atualizado */}
              ...
              sorted.map((a) => {
                ...
                return (
                  <tr key={a.id} className="h-[54px] text-sm">
                    ...
                    {/* Email: reticências + hover + clique copia */}
                    <td className="px-2 py-1 align-middle">
                      <button
                        type="button"
                    ...
                    {/* Status: espaço real, sem sobrepor */}
