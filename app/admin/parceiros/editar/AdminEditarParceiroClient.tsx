      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="md:col-span-2 space-y-4">
          ...
          <div className={card}>
            ...
            <input value={whatsapp} onChange={(e) => setWhatsapp(e.target.value)} className={inputBase} />
            <p className={help}>Obrigatório.</p>
          </div>

          <div className={card}>
            <label className={label}>Instagram (opcional)</label>
            <input value={instagram} onChange={(e) => setInstagram(e.target.value)} className={inputBase} />
          </div>
