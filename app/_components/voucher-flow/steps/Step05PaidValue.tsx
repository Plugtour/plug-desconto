// app/_components/voucher-flow/steps/Step05PaidValue.tsx
'use client';
...
export default function Step05PaidValue({
  initialValue = 0,
  onNext,
  onClose,
  disabled = false,
    ...
    <div className="w-full px-4 py-5">
      <div className="mx-auto w-full max-w-[420px] rounded-2xl border border-black/10 bg-white p-5 shadow-sm">
        <div className="text-center">
          <p className="text-[13px] leading-5 text-black/70">Valor pago</p>

          <h2 className="mt-1 text-[14px] font-semibold leading-6 text-black">
            Qual foi o valor pago ao estabelecimento?
          </h2>
        </div>
