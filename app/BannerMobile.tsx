      ...
      <div className="relative">
        ...
        >
          {items.map((b) => {
            ...
            const card = (
              <div
                className={`relative w-full shrink-0 snap-start ${heightClassName} rounded-2xl overflow-hidden`}
              >
                <img
                  src={b.imageUrl}
                  alt={b.title}
                ...
                <div className="relative h-full w-full p-4">
                  <div
                    className={`flex h-full w-full flex-col justify-end gap-1 ${contentAlign}`}
                  >
